...
export default function Header({ title, showUser = true }: HeaderProps) {
  ...
  return (
    <header className="bg-gradient-to-r from-fbz-primary to-fbz-secondary text-white px-6 pt-safe pb-6 sticky top-0 z-40 shadow-lg">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <Image src="/logo.png" alt="FBZ Barbearia" width={64} height={64} className="object-contain" />
            <div>
              <h1 className="text-xl font-bold">FBZ Barbearia</h1>
            </div>
          </div>
