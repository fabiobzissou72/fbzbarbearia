...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-20 left-0 right-0 z-50 px-4 animate-slideIn">
      <div className="max-w-md mx-auto bg-gradient-to-r from-fbz-primary to-fbz-secondary text-white rounded-xl shadow-2xl p-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="flex-1 bg-white text-fbz-primary font-medium py-2 px-4 rounded-lg hover:bg-white/90 transition-colors flex items-center justify-center space-x-2"
              >
