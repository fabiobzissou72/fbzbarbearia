  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="max-w-2xl mx-auto px-6 py-6 space-y-6">
        ...
        {proximoAgendamento ? (
          <div className="card bg-gradient-to-br from-fbz-primary to-fbz-secondary text-white p-6 animate-fadeIn">
          ...
          <div className="card bg-gradient-to-br from-fbz-primary to-fbz-secondary text-white p-6 text-center">
            ...
            <Link href="/agendar" className="inline-block px-6 py-3 bg-white text-fbz-primary font-semibold rounded-lg border-2 border-white hover:bg-white/90 transition-colors">
              Agendar agora
            </Link>
          </div>
        )}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link
              href="/agendar"
              className="card bg-white dark:bg-slate-800 hover:shadow-lg transition-all active:scale-95 text-center p-6 border border-fbz-primary/20"
            >
              <Calendar className="w-10 h-10 mx-auto mb-3 text-fbz-primary dark:text-fbz-accent" />
            ...
            <Link
              ...
              className="card bg-white dark:bg-slate-800 hover:shadow-lg transition-all active:scale-95 text-center p-6 border border-fbz-primary/20"
            >
              <Clock className="w-10 h-10 mx-auto mb-3 text-fbz-primary dark:text-fbz-accent" />
        ...
        {proximosAgendamentos.length > 1 && (
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/agendamentos" className="text-sm text-fbz-primary hover:text-fbz-secondary">
                Ver todos
              </Link>
            </div>
        ...
        {/* Informações úteis */}
        <div className="card bg-fbz-primary/5 border-fbz-primary/20 p-4">
          <h3 className="font-bold mb-3 flex items-center">
            <Clock className="w-5 h-5 mr-2 text-fbz-primary dark:text-fbz-accent" />
          ...
          <div className="mt-3 pt-3 border-t border-fbz-primary/20">
            <h3 className="font-bold mb-2 flex items-center text-slate-900 dark:text-white">
              <svg className="w-5 h-5 mr-2 text-fbz-primary dark:text-fbz-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="text-sm text-fbz-primary dark:text-white hover:underline flex items-start"
            >
              <span>Rua 9 c/ Rua t-53, 2323, Setor Marista, Goiânia</span>
              <svg className="w-4 h-4 ml-1 flex-shrink-0 mt-0.5 text-fbz-primary dark:text-fbz-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
