...
export default function RecuperarSenhaPage() {
  ...
  if (enviado) {
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-fbz-dark via-fbz-primary to-fbz-secondary">
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="max-w-md w-full text-center space-y-6 animate-fadeIn">
            ...
            <div className="space-y-3">
              ...
              <p className="text-fbz-accent text-lg">
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-fbz-dark via-fbz-primary to-fbz-secondary">
      ...
      <div className="flex-shrink-0 pt-8 pb-6 px-6">
        ...
        <div className="text-center">
          ...
          <p className="text-fbz-accent">Digite seu telefone para receber uma senha temporária</p>
        </div>
      </div>

      {/* Form */}
      <div className="flex-1 bg-white dark:bg-fbz-dark rounded-t-3xl px-6 py-8">
        <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-fbz-primary focus:border-transparent transition-all duration-200"
                disabled={loading}
                autoFocus
              />
            </div>
          ...
          <div className="pt-4 border-t border-border">
            <div className="bg-fbz-primary/10 border border-fbz-primary/20 rounded-lg p-4">
