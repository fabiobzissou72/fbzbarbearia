...
export default function InstalarPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="bg-gradient-to-r from-fbz-primary to-fbz-secondary text-white px-6 py-8">
        <Link
          href="/login"
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="card p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 rounded-full bg-fbz-primary text-white flex items-center justify-center text-sm font-bold flex-shrink-0 mt-1">
                1
              </div>
        ...
        {/* Dúvidas */}
        <div className="card p-6 bg-fbz-primary/5 border-fbz-primary/20">
