  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-fbz-dark via-fbz-primary to-fbz-secondary">
      ...
      <div className="flex-shrink-0 pt-12 pb-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-white mb-2">FBZ Barbearia</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-6 max-w-md mx-auto">
          ...
          <div className="text-center">
            <Link
              ...
              className="text-sm text-fbz-primary dark:text-fbz-accent font-medium hover:underline"
            >
              Esqueci minha senha
            </Link>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground dark:text-gray-300">
              Primeira vez aqui?{' '}
              <Link href="/cadastro" className="text-fbz-primary dark:text-fbz-accent font-medium hover:underline">
                Fazer cadastro
              </Link>
            </p>
          </div>
