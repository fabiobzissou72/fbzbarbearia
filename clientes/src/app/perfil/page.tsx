    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="max-w-2xl mx-auto px-6 py-6">
        ...
        <div className="card p-6 mb-6 text-center">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-fbz-primary to-fbz-secondary text-white flex items-center justify-center text-2xl font-bold mx-auto mb-4">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  disabled={salvando}
                  className="p-2 rounded-lg bg-fbz-primary text-white hover:bg-fbz-secondary transition-colors"
                >
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-lg border-2 transition-all ${
                      dadosEditados.tem_filhos === true
                        ? 'border-fbz-primary bg-fbz-primary/10'
                        : 'border-border'
                    }`}
                  >
                    Sim
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="flex items-center space-x-2 text-fbz-primary hover:text-fbz-secondary transition-colors"
              >
        ...
        {!editando && (
          <div className="mt-6">
            {alterandoSenha ? (
              ...
              >
                <div className="flex items-center space-x-3">
                  <Lock className="w-5 h-5 text-fbz-primary" />
        ...
        {!editando && !alterandoSenha && podeInstalar && deferredPrompt && (
          <button
            ...
            className="mt-6 w-full card p-4 flex items-center justify-center space-x-3 bg-gradient-to-r from-fbz-primary to-fbz-secondary text-white hover:shadow-lg transition-all"
          >
