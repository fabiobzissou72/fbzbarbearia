    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-fbz-dark via-fbz-primary to-fbz-secondary">
      ...
      <div className="flex-shrink-0 pt-8 pb-6 px-6">
        ...
        <div className="text-center">
          ...
          <p className="text-fbz-accent">Etapa {etapa} de 2</p>
        </div>
      ...
      {/* Form */}
      <div className="flex-1 bg-white dark:bg-fbz-dark rounded-t-3xl px-6 py-8 overflow-y-auto">
        <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto">
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-lg border-2 transition-all ${
                      dados.tem_filhos === true
                        ? 'border-fbz-primary bg-fbz-primary/10 text-fbz-primary'
                        : 'border-border hover:border-fbz-primary/50'
                    }`}
                  >
          ...
          <div className="text-center pt-4 border-t border-border">
            <p className="text-sm text-muted-foreground">
              Já tem uma conta?{' '}
              <Link href="/login" className="text-fbz-primary hover:text-fbz-secondary transition-colors font-medium">
                Entrar
              </Link>
            </p>
          </div>
