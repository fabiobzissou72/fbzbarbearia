        ...
        <div className="flex space-x-2 mb-6">
          <button
            ...
            className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${
              filtro === 'proximos'
                ? 'bg-fbz-primary text-white shadow-lg'
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 rounded-full bg-fbz-primary/10 flex items-center justify-center">
                      <Calendar className="w-6 h-6 text-fbz-primary" />
                    </div>
                    <div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="pt-3 border-t border-border space-y-2">
                      ...
                      {agendamento.valor && (
                        <div className="pt-2 mt-2 border-t border-border flex items-center justify-between">
                          ...
                          <span className="text-base font-bold text-fbz-gold">
                  ...
                  {agendamento.observacoes && agendamento.observacoes.startsWith('COMPRA:') && (
                    <div className="pt-3 border-t border-border">
                      ...
                      <p className="text-sm font-medium text-fbz-primary">
