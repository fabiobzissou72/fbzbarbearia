# 📋 Recursos e Funcionalidades - FBZ Cliente App
...
- [x] Cores personalizadas da FBZ (azul)
...
O app está integrado com a API existente do sistema FBZ, que significa:
