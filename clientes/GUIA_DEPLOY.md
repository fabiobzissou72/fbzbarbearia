# 🚀 Guia Completo de Deploy - FBZ Cliente App

Este guia fornece instruções passo a passo para configurar e fazer deploy do aplicativo cliente da FBZ Barbearia.
...
2. Nome: `fbzcliente` (ou outro de sua preferência)
...
# Primeiro commit
git commit -m "🎉 Initial commit - FBZ Cliente App PWA"

# Conectar ao repositório remoto (substitua com seu URL)
git remote add origin https://github.com/fabiobzissou72/fbzclientebarbearia.git
...
4. Importe o repositório `fbzcliente`
...
| `NEXT_PUBLIC_APP_NAME` | `FBZ Barbearia` |
...
2. Adicione seu domínio personalizado (ex: `app.fbzbarbearia.com.br`)
...
**IMPORTANTE:** Você precisa gerar os ícones a partir do logo da FBZ.
...
Seu aplicativo cliente da FBZ Barbearia está no ar!
