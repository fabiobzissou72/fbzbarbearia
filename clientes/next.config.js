const withPWA = require('next-pwa')({
  ...
  runtimeCaching: [
    ...
    {
      urlPattern: /^https:\/\/fbzbarbearia\.vercel\.app\/api\/.*/,
    ...
    {
      urlPattern: /^https:\/\/fbzclientebarbearia\.vercel\.app\/api\/proxy\/.*/,
      handler: 'NetworkOnly'
    },
    {
...
const nextConfig = {
  ...
  images: {
    domains: ['fbzbarbearia.vercel.app', 'nypuvicehlmllhbudghf.supabase.co']
  }
}
