# FBZ Barbearia - Aplicativo Cliente (PWA)

Aplicativo Progressive Web App (PWA) para clientes da FBZ Barbearia realizarem agendamentos.
...
```bash
git clone https://github.com/fabiobzissou72/fbzclientebarbearia.git
cd fbzclientebarbearia
```
...
Para dúvidas e suporte, entre em contato com a FBZ Barbearia.

## 📄 Licença

© 2024 FBZ Barbearia. Todos os direitos reservados.
