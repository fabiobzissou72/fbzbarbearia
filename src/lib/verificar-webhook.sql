...
SELECT 'https://webhook.fbzia.com.br/webhook/dashbarbearia'
WHERE NOT EXISTS (SELECT 1 FROM configuracoes);

-- 3. Atualizar webhook existente
UPDATE configuracoes
SET webhook_url = 'https://webhook.fbzia.com.br/webhook/dashbarbearia'
WHERE webhook_url IS NULL
   OR webhook_url != 'https://webhook.fbzia.com.br/webhook/dashbarbearia';

-- 4. Verificar se foi atualizado
SELECT
  webhook_url,
  CASE
    WHEN webhook_url = 'https://webhook.fbzia.com.br/webhook/dashbarbearia' THEN '✅ Configurado corretamente'
...
-- ============================================
/*
POST https://webhook.fbzia.com.br/webhook/dashbarbearia
