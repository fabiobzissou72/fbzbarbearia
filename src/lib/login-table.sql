...
((SELECT id FROM profissionais WHERE nome = 'Hiago' LIMIT 1), 'hiago@barbearia.com', '123456'),
((SELECT id FROM profissionais WHERE nome = 'Alex' LIMIT 1), 'alex@barbearia.com', '123456'),
((SELECT id FROM profissionais WHERE nome = 'Filippe' LIMIT 1), 'filippe@barbearia.com', '123456');
*/