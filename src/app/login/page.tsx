        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-8">
          ...
          <div className="text-center mb-8">
            <div className="mx-auto w-24 h-24 flex items-center justify-center mb-4">
              <img src="/logo.png" alt="Barbearia" className="w-full h-full object-contain" />
            </div>
            <h1 className="text-2xl font-bold text-white mb-2">BARBEARIA</h1>
            <p className="text-cyan-400 text-sm font-medium">Sistema de Gestão</p>
          </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-slate-400 text-xs">
              Dashboard administrativo • Barbearia
            </p>
          </div>
        </div>
      </div>
